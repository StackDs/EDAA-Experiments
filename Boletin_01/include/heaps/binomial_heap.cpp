...
class binomial_heap
{
    ...
    private:
        ...
        // Libera recursivamente un arbol binomial y sus hermanos
        ...
        list<Node*> extractMin(list<Node*> _heap)
        {
            ...
            delete temp; // Libera el nodo raiz extraido
    ...
    public:
        ...
        // Libera toda la memoria de los arboles del heap
        void clear(void)
        {
            for (Node *r : roots) {
                freeTree(r);
        ...
        // Deshabilitar copia para prevenir double-free por punteros compartidos
        binomial_heap(const binomial_heap&) = delete;
        binomial_heap& operator=(const binomial_heap&) = delete;

        // Movimiento semantico
        binomial_heap(binomial_heap&& other) noexcept : roots(std::move(other.roots)) {}
        ...
        void meld(binomial_heap &h)
        {
            ...
            h.roots.clear(); // Transfiere posesion para evitar doble liberacion
        }
